/** @file
  NoAsanSetMem() and NoAsanSetMemN() implementation.
  ...
  )
{
  ...
  return NoAsanInternalMemSetMem (Buffer, Length, Value);
}
  ...
  )
{
  if (sizeof (UINTN) == sizeof (UINT64)) {
    return NoAsanSetMem64 (Buffer, Length, (UINT64)Value);
  } else {
    return NoAsanSetMem32 (Buffer, Length, (UINT32)Value);
  }
}
